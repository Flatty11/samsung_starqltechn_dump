#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/bootdevice/by-name/recovery:40075792:83ae5515bf8c6d77c94629dc35b383aa8c224313; then
  applypatch EMMC:/dev/block/bootdevice/by-name/boot:31650320:84bf9d50e79f1326115c90da3e1d2de762ce8d48 EMMC:/dev/block/bootdevice/by-name/recovery 83ae5515bf8c6d77c94629dc35b383aa8c224313 40075792 84bf9d50e79f1326115c90da3e1d2de762ce8d48:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
